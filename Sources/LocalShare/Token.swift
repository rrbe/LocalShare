...
enum Token {
    // 32 hex characters = 128 bits. The old 10-character base36 token was suitable
    // for LAN address hiding, but too small once a link can cross the public internet.
