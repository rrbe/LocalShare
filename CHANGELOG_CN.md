...
- 新增媒体网格浏览，支持图片和视频缩略图及浏览器内预览
- 列表和网格视图均支持批量下载
- 新增可配置的自动停止分享时间，适用于文件和文本分享
- 设置页改用双栏侧边导航

## [0.12.0] - 2026-08-27

- 新增可选的短访问码：可手动输入网址和短码加入分享，并带有限流和凭证自动轮换保护
- 新增 Hostname 与可选的 Tailscale 备用地址，同时保留一个主二维码入口，其余路径紧凑收纳在折叠区
- 优化地址操作：悬停时显示展开与复制按钮，同时支持键盘和 VoiceOver 访问

## [0.11.0] - 2026-08-12

- 新增自适应宽布局：原生文件选择和自定义浏览器预览可按需展开，同时保留现有紧凑布局作为默认值
- 设置中新增手动「检查更新」，并让本地构建版本号与 Sparkle 更新排序保持兼容

## [0.10.0] - 2026-07-06

- 新增 macOS 分享扩展：可从系统「分享」菜单直接把文件和文件夹发送到 LocalShare
- 项目文档完成国际化，安装、架构、设计和协作说明都有英文版本
